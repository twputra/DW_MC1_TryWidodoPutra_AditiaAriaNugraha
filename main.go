...
func PowerUp(anime Profile, multiplier int) Profile {
	anime.Health = anime.Health + (anime.Health * multiplier)
	anime.Power = anime.Power + (anime.Power * multiplier)
	anime.Exp = anime.Exp + (anime.Exp * multiplier)
	return anime
}
